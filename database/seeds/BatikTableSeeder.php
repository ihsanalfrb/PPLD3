...
class BatikTableSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       $this->create_batik_model('Arum Dalu', 'absde', 'efgh', '', 'Jepara', 'CPK001-Arum Dalu.png', '');
       $this->create_batik_model('Blibar11', 'absde', 'efgh', '', 'Yogyakarta', 'CPK003-Blibar11.png', '');
       $this->create_batik_model('Blibar12', 'absde', 'efgh', '', 'Yogyakarta', 'CPK003-Blibar12.png', '');
       $this->create_batik_model('Blibar13', 'absde', 'efgh', '', 'Yogyakarta', 'CPK003-Blibar13.png', '');
       $this->create_batik_model('Blibar14', 'absde', 'efgh', '', 'Yogyakarta', 'CPK003-Blibar14.png', '');
       $this->create_batik_model('Blibar21', 'absde', 'efgh', '', 'Yogyakarta', 'CPK004-Blibar21.png', '');
       $this->create_batik_model('Blibar22', 'absde', 'efgh', '', 'Yogyakarta', 'CPK004-Blibar22.png', '');
       $this->create_batik_model('Blibar23', 'absde', 'efgh', '', 'Yogyakarta', 'CPK004-Blibar23.png', '');
       $this->create_batik_model('Blibar24', 'absde', 'efgh', '', 'Yogyakarta', 'CPK004-Blibar24.png', '');
       $this->create_batik_model('Budi Luhur1', 'absde', 'efgh', '', 'Jepara', 'CPK005-Budi Luhur1.png', '');
       $this->create_batik_model('Budi Luhur2', 'absde', 'efgh', '', 'Jepara', 'CPK005-Budi Luhur2.png', '');
       ...
       $this->create_batik_model('Sekar Bangah1', 'absde', 'efgh', 'Sekar', 'Solo', 'CPK026-Sekar Bangah1.png', '');
       $this->create_batik_model('Sekar Bangah2', 'absde', 'efgh', 'Sekar', 'Solo', 'CPK026-Sekar Bangah2.png', '');
       ...
       $this->create_batik_model('Gambiro Wati1', 'absde', 'efgh', '', 'Solo', 'CPK033-Gambiro Wati1.png', '');
       $this->create_batik_model('Gambiro Wati2', 'absde', 'efgh', '', 'Solo', 'CPK033-Gambiro Wati2.png', '');
       $this->create_batik_model('Gendala Giri1', 'absde', 'efgh', '', 'Solo', 'CPK035-Gendala Giri1.png', '');
       $this->create_batik_model('Gendala Giri2', 'absde', 'efgh', '', 'Solo', 'CPK035-Gendala Giri2.png', '');
       $this->create_batik_model('Glagah Kurung', 'absde', 'efgh', '', 'Yogyakarta', 'CPK036-Glagah Kurung.png', '');
       $this->create_batik_model('Grompol I1', 'absde', 'efgh', '', 'Yogyakarta', 'CPK037-Grompol I1.png', '');
       $this->create_batik_model('Grompol I2', 'absde', 'efgh', '', 'Yogyakarta', 'CPK037-Grompol I2.png', '');
       $this->create_batik_model('Grompol II1', 'absde', 'efgh', '', 'Yogyakarta', 'CPK038-Grompol II1.png', '');
       $this->create_batik_model('Grompol II2', 'absde', 'efgh', '', 'Yogyakarta', 'CPK038-Grompol II2.png', '');
       $this->create_batik_model('Kartiko Wati1', 'absde', 'efgh', '', 'Yogyakarta', 'CPK040-Kartiko Wati1.png', '');
       $this->create_batik_model('Kartiko Wati2', 'absde', 'efgh', '', 'Yogyakarta', 'CPK040-Kartiko Wati2.png', '');
       $this->create_batik_model('Kembang Kapas1', 'absde', 'efgh', 'Kembang', 'Madura', 'CPK041-Kembang Kapas1.png', '');
       $this->create_batik_model('Kembang Kapas2', 'absde', 'efgh', 'Kembang', 'Madura', 'CPK041-Kembang Kapas2.png', '');
       $this->create_batik_model('Kembang Kapas3', 'absde', 'efgh', 'Kembang', 'Madura', 'CPK041-Kembang Kapas3.png', '');
       $this->create_batik_model('Kembang Pala1', 'absde', 'efgh', 'Kembang', 'Cirebon', 'CPK042-Kembang Pala1.png', '');
       $this->create_batik_model('Kembang Pala2', 'absde', 'efgh', 'Kembang', 'Cirebon', 'CPK042-Kembang Pala2.png', '');
       $this->create_batik_model('Kembang Tanjung1', 'absde', 'efgh', 'Kembang', 'Yogyakarta', 'CPK043-Kembang Tanjung1.png', '');
       $this->create_batik_model('Kembang Tanjung2', 'absde', 'efgh', 'Kembang', 'Yogyakarta', 'CPK043-Kembang Tanjung2.png', '');
       $this->create_batik_model('Kenanga Sari1', 'absde', 'efgh', '', 'Surabaya', 'CPK044-Kenanga Sari1.png', '');
       $this->create_batik_model('Kenanga Sari2', 'absde', 'efgh', '', 'Surabaya', 'CPK044-Kenanga Sari2.png', '');
       $this->create_batik_model('Kerton Bekingking', 'absde', 'efgh', '', 'Solo', 'CPK045-Kerton Bekingking.png', '');
       $this->create_batik_model('Kerton Pari Anom', 'absde', 'efgh', '', 'Solo', 'CPK046-Kerton Pari Anom.png', '');
       $this->create_batik_model('Konang Sakebon1', 'absde', 'efgh', '', 'Solo', 'CPK048-Konang Sakebon1.png', '');
       $this->create_batik_model('Konang Sakebon2', 'absde', 'efgh', '', 'Solo', 'CPK048-Konang Sakebon2.png', '');
       $this->create_batik_model('Kotak Banci Kasut', 'absde', 'efgh', 'Kotak', 'Yogyakarta', 'CPK049-Kotak Banci Kasut.png', '');
       $this->create_batik_model('Kotak Jamblang', 'absde', 'efgh', 'Kotak', 'Cirebon', 'CPK050-Kotak Jamblang.png', '');
       $this->create_batik_model('Kotak Peksi Kurung1', 'absde', 'efgh', 'Kotak', 'Yogyakarta', 'CPK051-Kotak Peksi Kurung1.png', '');
       $this->create_batik_model('Kotak Peksi Kurung2', 'absde', 'efgh', 'Kotak', 'Yogyakarta', 'CPK051-Kotak Peksi Kurung2.png', '');
       $this->create_batik_model('Kupu Anom', 'absde', 'efgh', '', 'Yogyakarta', 'CPK052-Kupu Anom.png', '');
       $this->create_batik_model('Lara Sedowo1', 'absde', 'efgh', '', 'Yogyakarta', 'CPK053-Lara Sedowo1.png', '');
       $this->create_batik_model('Lara Sedowo2', 'absde', 'efgh', '', 'Yogyakarta', 'CPK053-Lara Sedowo2.png', '');
       $this->create_batik_model('Limaran1', 'absde', 'efgh', '', 'Solo', 'CPK054-Limaran1.png', '');
       $this->create_batik_model('Limaran2', 'absde', 'efgh', '', 'Solo', 'CPK054-Limaran2.png', '');
       $this->create_batik_model('Melati Rinonce I1', 'absde', 'efgh', '', 'Solo', 'CPK055-Melati Rinonce I1.png', '');
       $this->create_batik_model('Melati Rinonce I2', 'absde', 'efgh', '', 'Solo', 'CPK055-Melati Rinonce I2.png', '');
       $this->create_batik_model('Sawo Bludru1', 'absde', 'efgh', '', 'Yogyakarta', 'CPK061-Sawo Bludru1.png', '');
       $this->create_batik_model('Sawo Bludru2', 'absde', 'efgh', '', 'Yogyakarta', 'CPK061-Sawo Bludru2.png', '');
       $this->create_batik_model('Sekar Kopi1', 'absde', 'efgh', 'Sekar', 'Jepara', 'CPK063-Sekar Kopi1.png', '');
       $this->create_batik_model('Sekar Kopi2', 'absde', 'efgh', 'Sekar', 'Jepara', 'CPK063-Sekar Kopi2.png', '');
       $this->create_batik_model('Sekar Sembojo', 'absde', 'efgh', 'Sekar', 'Jepara', 'CPK064-Sekar Sembojo.png', '');
       $this->create_batik_model('Sekar Sidoguri1', 'absde', 'efgh', 'Sekar', 'Jepara', 'CPK065-Sekar Sidoguri1.png', '');
       $this->create_batik_model('Sekar Sidoguri2', 'absde', 'efgh', 'Sekar', 'Jepara', 'CPK065-Sekar Sidoguri2.png', '');
       $this->create_batik_model('Sekar Tanjung', 'absde', 'efgh', 'Sekar', 'Jepara', 'CPK066-Sekar Tanjung.png', '');
       $this->create_batik_model('Sekar Turi1', 'absde', 'efgh', 'Sekar', 'Yogyakarta', 'CPK067-Sekar Turi1.png', '');
       $this->create_batik_model('Sekar Turi2', 'absde', 'efgh', 'Sekar', 'Yogyakarta', 'CPK067-Sekar Turi2.png', '');
       $this->create_batik_model('Sido Mulyo II1', 'absde', 'efgh', '', 'Solo', 'CPK072-Sido Mulyo II1.png', '');
       $this->create_batik_model('Sido Mulyo II2', 'absde', 'efgh', '', 'Solo', 'CPK072-Sido Mulyo II2.png', '');
       $this->create_batik_model('Sumber Lintang1', 'absde', 'efgh', '', 'Solo', 'CPK074-Sumber Lintang1.png', '');
       ...
       $this->create_batik_model('Sawo Pecah', 'absde', 'efgh', '', 'Jepara', 'KWG022-Sawo Pecah.png', '');
       $this->create_batik_model('Sawo Tanjungsari', 'absde', 'efgh', '', 'Jepara', 'KWG023-Sawo Tanjungsari.png', '');
       ...
       $this->create_batik_model('Rujak Senthe I', 'absde', 'efgh', '', 'Yogyakarta', 'LRG012-Rujak Senthe I.png', '');

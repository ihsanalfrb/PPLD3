...
class BatikTableSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       $this->create_batik_model('Ceplok Abimanyu1', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Abimanyu2', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Abimanyu3', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Ambar Sekar', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Gambir Anom', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Gusti Putri1', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Jelanggrong', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Keci1', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Keci2', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Kembang Tebu1', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Kembang Tebu2', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Kembang Waru1', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Kembang Waru2', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Kenongo1', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Kenongo2', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Kenongo3', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Lenggang Kangkung', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Mawar Sari', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Mulyo1', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Mulyo2', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Pamugari 11', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Pamugari 12', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Pamugari 21', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Pamugari 22', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Prana Jiwa1', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Prana Jiwa2', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Sekar Bangah1', 'absde', 'efgh', 'Sekar', 'Solo');
       $this->create_batik_model('Sekar Bangah2', 'absde', 'efgh', 'Sekar', 'Solo');
       $this->create_batik_model('Ceplok Sekar Sidoguri', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Sirap', 'absde', 'efgh', 'Ceplok', 'Yogyakarta');
       $this->create_batik_model('Ceplok Tanjungsari1', 'absde', 'efgh', 'Ceplok', 'Solo');
       $this->create_batik_model('Ceplok Tanjungsari2', 'absde', 'efgh', 'Ceplok', 'Solo');
       $this->create_batik_model('Ceplok Wahyuningrat1', 'absde', 'efgh', 'Ceplok', 'Solo');
       $this->create_batik_model('Ceplok Wahyuningrat2', 'absde', 'efgh', 'Ceplok', 'Solo');
       ...
       $this->create_batik_model('Kembang Kapas1', 'absde', 'efgh', 'Kembang', 'Madura');
       $this->create_batik_model('Kembang Kapas2', 'absde', 'efgh', 'Kembang', 'Madura');
       $this->create_batik_model('Kembang Kapas3', 'absde', 'efgh', 'Kembang', 'Madura');
       $this->create_batik_model('Kembang Pala1', 'absde', 'efgh', 'Kembang', 'Cirebon');
       $this->create_batik_model('Kembang Pala2', 'absde', 'efgh', 'Kembang', 'Cirebon');
       $this->create_batik_model('Kembang Tanjung1', 'absde', 'efgh', 'Kembang', 'Yogyakarta');
       $this->create_batik_model('Kembang Tanjung2', 'absde', 'efgh', 'Kembang', 'Yogyakarta');
       ...
       $this->create_batik_model('Kotak Banci Kasut', 'absde', 'efgh', 'Kotak', 'Yogyakarta');
       $this->create_batik_model('Kotak Jamblang', 'absde', 'efgh', 'Kotak', 'Cirebon');
       $this->create_batik_model('Kotak Peksi Kurung1', 'absde', 'efgh', 'Kotak', 'Yogyakarta');
       $this->create_batik_model('Kotak Peksi Kurung2', 'absde', 'efgh', 'Kotak', 'Yogyakarta');
       ...
       $this->create_batik_model('Sekar Kopi1', 'absde', 'efgh', 'Sekar', 'Jepara');
       $this->create_batik_model('Sekar Kopi2', 'absde', 'efgh', 'Sekar', 'Jepara');
       $this->create_batik_model('Sekar Sembojo', 'absde', 'efgh', 'Sekar', 'Jepara');
       $this->create_batik_model('Sekar Sidoguri1', 'absde', 'efgh', 'Sekar', 'Jepara');
       $this->create_batik_model('Sekar Sidoguri2', 'absde', 'efgh', 'Sekar', 'Jepara');
       $this->create_batik_model('Sekar Tanjung', 'absde', 'efgh', 'Sekar', 'Jepara');
       $this->create_batik_model('Sekar Turi1', 'absde', 'efgh', 'Sekar', 'Yogyakarta');
       $this->create_batik_model('Sekar Turi2', 'absde', 'efgh', 'Sekar', 'Yogyakarta');
       ...
       $this->create_batik_model('Kawung Beton', 'absde', 'efgh', 'Kawung', 'Yogyakarta');
       $this->create_batik_model('Kawung Brendhi', 'absde', 'efgh', 'Kawung', 'Yogyakarta');
       $this->create_batik_model('Kawung Cacah Gori', 'absde', 'efgh', 'Kawung', 'Yogyakarta');
       $this->create_batik_model('Kawung Galar', 'absde', 'efgh', 'Kawung', 'Solo');
       $this->create_batik_model('Kawung Gamblok', 'absde', 'efgh', 'Kawung', 'Jepara');
       $this->create_batik_model('Kawung Kepyar', 'absde', 'efgh', 'Kawung', 'Jepara');
       $this->create_batik_model('Kawung Ndil', 'absde', 'efgh', 'Kawung', 'Jepara');
       $this->create_batik_model('Kawung Picis', 'absde', 'efgh', 'Kawung', 'Jepara');
       $this->create_batik_model('Kawung Plentong', 'absde', 'efgh', 'Kawung', 'Jepara');
       $this->create_batik_model('Kawung Putri', 'absde', 'efgh', 'Kawung', 'Jepara');
       $this->create_batik_model('Kawung Sen', 'absde', 'efgh', 'Kawung', 'Jepara');
       $this->create_batik_model('Kawung Ukel', 'absde', 'efgh', 'Kawung', 'Jepara');
       $this->create_batik_model('Kawung Uter', 'absde', 'efgh', 'Kawung', 'Jepara');
       $this->create_batik_model('Kawung Manila', 'absde', 'efgh', 'Kawung', 'Jepara');
       $this->create_batik_model('Sawo Pecah', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Sawo Tanjungsari', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Lereng Dana Tirta', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Abiyoso', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Bangun Ningrat1', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Bangun Ningrat', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Blambangan', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Cagak Talang', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Candi Puro', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Golang galing', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Kembang Bayem', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Modang', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Paripurno', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Lereng Prana Jiwo', 'absde', 'efgh', 'Lereng', 'Cirebon');
       $this->create_batik_model('Rujak Senthe I', 'absde', 'efgh', '', 'Yogyakarta');
       $this->create_batik_model('Lereng Rujak Senthe II-1', 'absde', 'efgh', 'Lereng', 'Yogyakarta');
       $this->create_batik_model('Lereng Rujak Senthe II', 'absde', 'efgh', 'Lereng', 'Yogyakarta');
       $this->create_batik_model('Lereng Rujak Tales', 'absde', 'efgh', 'Lereng', 'Yogyakarta');
       $this->create_batik_model('Lereng Tatagati', 'absde', 'efgh', 'Lereng', 'Jepara');
       $this->create_batik_model('Lereng Tritis', 'absde', 'efgh', 'Lereng', 'Yogyakarta');
       $this->create_batik_model('Lereng Udan Riris', 'absde', 'efgh', 'Lereng', 'Yogyakarta');
       $this->create_batik_model('Lereng Uceng Udik', 'absde', 'efgh', 'Lereng', 'Yogyakarta');
       $this->create_batik_model('Lereng Sukoreno', 'absde', 'efgh', 'Lereng', 'Yogyakarta');
       $this->create_batik_model('Lereng Weningsari', 'absde', 'efgh', 'Lereng', 'Yogyakarta');
       $this->create_batik_model('Nitik Ceplok Liring', 'absde', 'efgh', 'Nitik', 'Pekalongan');
       $this->create_batik_model('Nitik Dara Gelar', 'absde', 'efgh', 'Nitik', 'Pekalongan');
       $this->create_batik_model('Nitik Grompol', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Kartika', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Kapulogo', 'absde', 'efgh', 'Nitik', 'Jepara');
       $this->create_batik_model('Nitik Nagasari', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Nujuprana', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Pandanwangi', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Rumpuk', 'absde', 'efgh', 'Nitik', 'Jepara');
       $this->create_batik_model('Nitik Sekar Andala', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Anggrek', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Bangah', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Blimbing', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Cendul', 'absde', 'efgh', 'Nitik', 'Solo');
       $this->create_batik_model('Nitik Sekar Cengkeh I', 'absde', 'efgh', 'Nitik', 'Solo');
       $this->create_batik_model('Nitik Sekar Cengkeh II', 'absde', 'efgh', 'Nitik', 'Solo');
       $this->create_batik_model('Nitik Sekar Delimo', 'absde', 'efgh', 'Nitik', 'Solo');
       $this->create_batik_model('Nitik Sekar Giwang', 'absde', 'efgh', 'Nitik', 'Solo');
       $this->create_batik_model('Nitik Sekar Jagung', 'absde', 'efgh', 'Nitik', 'Solo');
       $this->create_batik_model('Nitik Sekar Jali', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Jambe', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Jambet', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Kenongo', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Kentang', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Kepel', 'absde', 'efgh', 'Nitik', 'Jepara');
       $this->create_batik_model('Nitik Sekar Manggar', 'absde', 'efgh', 'Nitik', 'Jepara');
       $this->create_batik_model('Nitik Sekar Melati', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Menur', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Pala I', 'absde', 'efgh', 'Nitik', 'Jepara');
       $this->create_batik_model('Nitik Sekar Pala II', 'absde', 'efgh', 'Nitik', 'Jepara');
       $this->create_batik_model('Nitik Sekar Polong', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Randu I', 'absde', 'efgh', 'Nitik', 'Pekalongan');
       $this->create_batik_model('Nitik Sekar Randu II', 'absde', 'efgh', 'Nitik', 'Pekalongan');
       $this->create_batik_model('Nitik Sekar Randu III', 'absde', 'efgh', 'Nitik', 'Pekalongan');
       $this->create_batik_model('Nitik Sekar Sawo', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Sedah', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Tebu', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Teleng I', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Sekar Teleng II', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Tanjung Gunung I', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Tanjung Gunung II', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Nitik Tanjung Gunung III', 'absde', 'efgh', 'Nitik', 'Yogyakarta');
       $this->create_batik_model('Parang Curiga', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Curiga Nata', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Gendewa', 'absde', 'efgh', 'Parang', 'Jepara');
       $this->create_batik_model('Parang Harjono', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Joyopuro', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Karno', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Komojoyo', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Kondur Baris', 'absde', 'efgh', 'Parang', 'Jepara');
       $this->create_batik_model('Parang Kumudaningrat', 'absde', 'efgh', 'Parang', 'Jepara');
       $this->create_batik_model('Parang Kusumo', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Kusumo Besar', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Laras Madyo', 'absde', 'efgh', 'Parang', 'Jepara');
       $this->create_batik_model('Parang Larasati', 'absde', 'efgh', 'Parang', 'Jepara');
       $this->create_batik_model('Parang Muncar 1', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Muncar 2', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Muninggar', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Nengkulo', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Ningsih', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Pandan Sari', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Parikesit Putri', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Poncowati', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Rusak Barong', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Samba', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Sawut 2', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Sawut Seling', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Semiaji', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Seno', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Seto', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Sidoreno', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Sisik', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Srimpi', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Sukawati', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Sumbo', 'absde', 'efgh', 'Parang', 'Yogyakarta');
       $this->create_batik_model('Parang Tarupulo', 'absde', 'efgh', 'Parang', 'Yogyakarta');
    }

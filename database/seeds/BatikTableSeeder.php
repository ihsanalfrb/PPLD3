...
class BatikTableSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       $this->create_batik_model('Nitik Tanjung Gunung I', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Nitik Tanjung Gunung II', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Nitik Tanjung Gunung III', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Curiga', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Curiga Nata', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Gendewa', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Harjono', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Joyopuro', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Karno', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Komojoyo', 'absde', 'efgh', '', 'Jepara');
       ...
       $this->create_batik_model('Parang Kusumo', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Kusumo Besar', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Laras Madyo', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Larasati', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Muncar 1', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Muncar 2', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Muninggar', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Nengkulo', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Ningsih', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Pandan Sari', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Parikesit Putri', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Poncowati', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Rusak Barong', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Samba', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Sawut 2', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Sawut Seling', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Semiaji', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Seno', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Seto', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Sidoreno', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Sisik', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Srimpi', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Sukawati', 'absde', 'efgh', '', 'Jepara');
       $this->create_batik_model('Parang Sumbo', 'absde', 'efgh', '', 'Jepara');

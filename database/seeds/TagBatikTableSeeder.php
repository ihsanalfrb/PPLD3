...
//        ]);
        ...
        $this->create_tag_batik_model('Abimanyu', 'Ceplok Abimanyu1');
        $this->create_tag_batik_model('Abimanyu', 'Ceplok Abimanyu2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Abimanyu2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Abimanyu3');
        $this->create_tag_batik_model('Abimanyu', 'Ceplok Abimanyu3');
        $this->create_tag_batik_model('Ambar', 'Ceplok Ambar Sekar');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Ambar Sekar');
        $this->create_tag_batik_model('Sekar', 'Ceplok Ambar Sekar');
        $this->create_tag_batik_model('Gambir', 'Ceplok Gambir Anom');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Gambir Anom');
        $this->create_tag_batik_model('Anom', 'Ceplok Gambir Anom');
        $this->create_tag_batik_model('Gusti', 'Ceplok Gusti Putri1');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Gusti Putri1');
        $this->create_tag_batik_model('Putri', 'Ceplok Gusti Putri1');
        $this->create_tag_batik_model('Jelanggrong', 'Ceplok Jelanggrong');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Jelanggrong');
        $this->create_tag_batik_model('Keci', 'Ceplok Keci1');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Keci1');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Keci2');
        $this->create_tag_batik_model('Keci', 'Ceplok Keci2');
        $this->create_tag_batik_model('Kembang', 'Ceplok Kembang Tebu1');
        $this->create_tag_batik_model('Tebu', 'Ceplok Kembang Tebu1');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Kembang Tebu1');
        $this->create_tag_batik_model('Tebu', 'Ceplok Kembang Tebu2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Kembang Tebu2');
        $this->create_tag_batik_model('Kembang', 'Ceplok Kembang Tebu2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Kembang Waru1');
        $this->create_tag_batik_model('Kembang', 'Ceplok Kembang Waru1');
        $this->create_tag_batik_model('Waru', 'Ceplok Kembang Waru1');
        $this->create_tag_batik_model('Kembang', 'Ceplok Kembang Waru2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Kembang Waru2');
        $this->create_tag_batik_model('Waru', 'Ceplok Kembang Waru2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Kenongo1');
        $this->create_tag_batik_model('Kenongo', 'Ceplok Kenongo1');
        $this->create_tag_batik_model('Kenongo', 'Ceplok Kenongo2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Kenongo2');
        $this->create_tag_batik_model('Kenongo', 'Ceplok Kenongo3');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Kenongo3');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Lenggang Kangkung');
        $this->create_tag_batik_model('Lenggang', 'Ceplok Lenggang Kangkung');
        $this->create_tag_batik_model('Kangkung', 'Ceplok Lenggang Kangkung');
        $this->create_tag_batik_model('Sari', 'Ceplok Mawar Sari');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Mawar Sari');
        $this->create_tag_batik_model('Mawar', 'Ceplok Mawar Sari');
        $this->create_tag_batik_model('Mulyo', 'Ceplok Mulyo1');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Mulyo1');
        $this->create_tag_batik_model('Mulyo', 'Ceplok Mulyo2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Mulyo2');
        $this->create_tag_batik_model('Pamugari', 'Ceplok Pamugari 11');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Pamugari 11');
        $this->create_tag_batik_model('Pamugari', 'Ceplok Pamugari 12');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Pamugari 12');
        $this->create_tag_batik_model('Pamugari', 'Ceplok Pamugari 21');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Pamugari 21');
        $this->create_tag_batik_model('Pamugari', 'Ceplok Pamugari 22');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Pamugari 22');
        $this->create_tag_batik_model('Prana', 'Ceplok Prana Jiwa1');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Prana Jiwa1');
        $this->create_tag_batik_model('Jiwa', 'Ceplok Prana Jiwa1');
        $this->create_tag_batik_model('Prana', 'Ceplok Prana Jiwa2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Prana Jiwa2');
        $this->create_tag_batik_model('Jiwa', 'Ceplok Prana Jiwa2');
        $this->create_tag_batik_model('Sekar', 'Sekar Bangah1');
        $this->create_tag_batik_model('Bangah', 'Sekar Bangah1');
        $this->create_tag_batik_model('Sekar', 'Sekar Bangah2');
        $this->create_tag_batik_model('Bangah', 'Sekar Bangah2');
        $this->create_tag_batik_model('Sidoguri', 'Ceplok Sekar Sidoguri');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Sekar Sidoguri');
        $this->create_tag_batik_model('Sekar', 'Ceplok Sekar Sidoguri');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Sirap');
        $this->create_tag_batik_model('Sirap', 'Ceplok Sirap');
        $this->create_tag_batik_model('Tanjungsari', 'Ceplok Tanjungsari1');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Tanjungsari1');
        $this->create_tag_batik_model('Tanjungsari', 'Ceplok Tanjungsari2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Tanjungsari2');
        $this->create_tag_batik_model('Wahyuningrat', 'Ceplok Wahyuningrat1');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Wahyuningrat1');
        $this->create_tag_batik_model('Wahyuningrat', 'Ceplok Wahyuningrat2');
        $this->create_tag_batik_model('Ceplok', 'Ceplok Wahyuningrat2');
        $this->create_tag_batik_model('Gambiro', 'Gambiro Wati1');
        $this->create_tag_batik_model('Wati', 'Gambiro Wati1');
        $this->create_tag_batik_model('Gambiro', 'Gambiro Wati2');
        $this->create_tag_batik_model('Wati', 'Gambiro Wati2');
        $this->create_tag_batik_model('Giri', 'Gendala Giri1');
        $this->create_tag_batik_model('Gendala', 'Gendala Giri1');
        $this->create_tag_batik_model('Giri', 'Gendala Giri2');
        $this->create_tag_batik_model('Gendala', 'Gendala Giri2');
        $this->create_tag_batik_model('Glagah', 'Glagah Kurung');
        $this->create_tag_batik_model('Kurung', 'Glagah Kurung');
        ...
        $this->create_tag_batik_model('Kartiko', 'Kartiko Wati1');
        $this->create_tag_batik_model('Wati', 'Kartiko Wati2');
        $this->create_tag_batik_model('Kartiko', 'Kartiko Wati2');
